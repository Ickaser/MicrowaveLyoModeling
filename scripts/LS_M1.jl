...
@df thmdat exptfplot!(:t, :T4, :T1, showline=true, linealpha=0.2, nmarks=15, ms=6)
...
@df thmdat exptfplot!(:t, :T4, showline=true, linealpha=0.2, nmarks=20, ms=6)
@df thmdat exptvwplot!(:t, :T3, nmarks=25, msw=3, ms=6)
...
@df thmdat exptfplot!(:t, :T4, showline=true, linealpha=0.2, nmarks=20, label="exp f")
